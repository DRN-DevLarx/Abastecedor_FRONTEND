...
function Comments() {
    return (
        <section className="bg-[#adb6aaa8] dark:bg-[#171731]  px-4">
            <hr className='text-gray-500 opacity-70'/>
            
            <div className="py-10 max-w-6xl mx-auto grid gap-8 grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3">
                
                <article className="bg-[#adb6aa] dark:bg-gray-800 p-6 rounded-lg shadow-md">
