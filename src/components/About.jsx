    ...
    return (
        <section class="bg-[#adb6aaa8] dark:bg-[#171731]">
            <div class="container px-6 py-5 mx-auto">
                ...
                <div class="mt-2 lg:flex lg:items-center">
                    ...
                    <div class="hidden lg:flex lg:w-1/2 lg:justify-center">
                        <img class="w-[25rem] h-[25rem] flex-shrink-0 object-cover rounded-full" src="https://images.unsplash.com/photo-1581291518857-4e27b48ff24e?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80" alt=""/>
                    </div>
                </div>
            </div>
        </section>
